...
#     data = Dataset('../data/PennFudanPed', get_transform(train=True))
# 
#     # split the dataset in train and test set
#     train_size = int(round(data.__len__() * 0.8))
#     test_size = data.__len__() - train_size
#     train, test = torch.utils.data.random_split(data, [train_size, test_size])

    train = Dataset('../data/PennFudanPed', get_transform(train=True))
    test = Dataset('../data/PennFudanPed', get_transform(train=False))
